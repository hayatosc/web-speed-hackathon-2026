...
import { sendFile, sendJSON } from "@web-speed-hackathon-2026/client/app/utils/fetchers";
...
const LazyNewPostModalPage = lazy(async () => {
  const { NewPostModalPage } =
    await import("@web-speed-hackathon-2026/client/app/components/new_post_modal/NewPostModalPage");
