...
//#region src/utils/create_translator.ts
async function createTranslator(params) {
	...
	return {
		async translate(text) {
			const content = (await engine.chat.completions.create({
				messages: [{
					role: "system",
			...
			invariant(parsed != null && "result" in parsed, "The translation result is missing in the reply.");
