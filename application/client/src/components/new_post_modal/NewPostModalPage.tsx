...
const loadImageConverter = () => import("@web-speed-hackathon-2026/client/src/utils/convert_image");
const loadMovieConverter = () => import("@web-speed-hackathon-2026/client/src/utils/convert_movie");
const loadSoundConverter = () => import("@web-speed-hackathon-2026/client/src/utils/convert_sound");
